var arrHead = new Array(); // array to store table headers
arrHead = ['', 'PID', 'Arrival Time', 'Burst Time']; // initialize the array with table header names
...
function initialize() {
    actat = new Array(n); // process arrival time tracker array
    ganttchart = new Array();
    timestamp = new Array();
    newBurstTime = new Array(n);
    visited = new Array(n); // if a process is visited or not
    t = 0; // time
    finish = 0; // finish time
    avgRT = 0; // average response time
